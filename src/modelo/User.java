...
/**
 * Clase que gestiona la autenticación y almacenamiento de usuarios en la base de datos MongoDB.
 */
public class User {
    ...
    /**
     * Realiza la primera conexión a la base de datos MongoDB y carga la configuración desde un archivo JSON.
     *
    ...
    public static void primeraConexion() throws JSONException {
        try {
            ...
            cardsESDB = colecciones.getString("cartas_es");
    ...
    /**
     * Inserta el primer usuario en la base de datos utilizando la configuración del archivo JSON.
     *
     * @throws JSONException Si ocurre un error al procesar el JSON.
     */
    public static void primerUsuario() throws JSONException {
        try {
            ...
            System.out.println("Primer Usuario: " + username);
            System.out.println("Contraseña SHA-256: " + passwordHash);
    ...
    /**
     * Verifica si un usuario existe en la base de datos y si su contraseña es correcta.
     *
     ...
     * @param pass Contraseña del usuario.
     * @return {@code true} si el usuario fue registrado correctamente, {@code false} si el usuario ya existe.
     */
